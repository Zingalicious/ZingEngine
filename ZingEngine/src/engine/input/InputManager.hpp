 ...
 */
static void mouse_button_callback(GLFWwindow* window, int button, int action, int mods) const;
 ...
 */
static void mouse_pos_callback(GLFWwindow* window, double xpos, double ypos) const;
 ...
 */
static void mouse_scroll_callback(GLFWwindow* window, double xoffset, double yoffset) const;
 ...
 * @param mods Bitfield of modifier keys.
 */
static void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods) const;
